...
class ControllerProductProduct extends Controller {
    ...
    public function index() {
        ...
        if ($category_info)
            $this->redirect($this->url->link('product/category', 'product_id=' . $product_info['product_id'] . '&path=' . $category_info[0]['category_id']));
        else {
            $this->redirect($this->url->link('product/category', 'product_id=' . $product_info['product_id']));
        }
